  ...
  return (
    <div className="relative h-full" ref={wrapperRef}>
      ...
      <CSSTransition in={props.isExpanded} timeout={200} unmountOnExit classNames="select-box-body">
        <ul className="select-box-body absolute p-6 font-bold shadow-dropdown border dark:shadow-dropdown-dark rounded-2xl min-w-[183px] mt-[0.625rem] right-0 flex flex-col gap-4 dark:bg-black-2 z-50">
          {props.children}
        </ul>
      </CSSTransition>
    </div>
